package indi.fmy.roottouch.jconst;
...
public class InputEventCodesConst {
    ...
    /**
     * BTN_TOUCH 我也不懂会不会有兼容性 问题
     */

    public static final int BTN_TOUCH_UP =0x00000000;

    public static final int BTN_TOUCH_DOWN=0x00000001;
